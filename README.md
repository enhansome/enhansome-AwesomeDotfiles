...
<details>
<summary><strong>NixOS</strong> (2)</summary>
...
* **[LambBread/my-dotfiles](https://github.com/LambBread/my-dotfiles) ⭐ 1 | 🐛 0 | 🌐 Nix | 📅 2026-09-18** — `anonymous`
...
* **[nickjj/dotfriedrice](https://github.com/nickjj/dotfriedrice) ⭐ 1,334 | 🐛 1 | 🌐 Shell | 📅 2026-09-13** — `nickjj`\
...
* **[Cybersnake223/Hypr](https://github.com/Cybersnake223/Hypr) ⭐ 468 | 🐛 0 | 🌐 Shell | 📅 2026-08-08** — `cybersnake223`\
  A minimal, keyboard-driven Hyprland dotfiles setup for Arch Linux. Laptop-first. Script-heavy. Zero bloat.
* **[cebem1nt/dotfiles](https://github.com/cebem1nt/dotfiles) ⭐ 293 | 🐛 0 | 🌐 Shell | 📅 2026-09-16** — `cebem1nt`\
...
* **[na-ive/nandoroid-shell](https://github.com/na-ive/nandoroid-shell) ⭐ 170 | 🐛 0 | 🌐 QML | 📅 2026-09-18** — `na-ive`\
  quickshell based hyprland shell, Android custom ROM inspired.
* **[zhaleff/BlackNode](https://github.com/zhaleff/BlackNode) ⭐ 166 | 🐛 3 | 🌐 Shell | 📅 2026-09-17** — `zhaleff`\
...
* **[berthosefin/dots](https://github.com/berthosefin/dots) ⭐ 20 | 🐛 0 | 🌐 Lua | 📅 2026-09-15** — `berthosefin`
* **[AdiKsOnDev/Monoland](https://github.com/AdiKsOnDev/Monoland) ⭐ 20 | 🐛 0 | 🌐 QML | 📅 2026-08-17** — `AdiKsOn`\
...
* **[Grey-007/Hyprmat-dots](https://github.com/Grey-007/Hyprmat-dots) ⭐ 10 | 🐛 0 | 🌐 CSS | 📅 2026-05-17** — `Grey-007`
* **[Aktyn/hyprland-setup](https://github.com/Aktyn/hyprland-setup) ⭐ 9 | 🐛 0 | 🌐 QML | 📅 2026-08-23** — `Aktyn`\
...
* **[ESHAYAT102/dotfiles](https://github.com/ESHAYAT102/dotfiles) ⭐ 8 | 🐛 0 | 🌐 QML | 📅 2026-09-19** — `Eshayat Al-Wasiu`\
...
* **[plutonium-sh/lazerbar](https://github.com/plutonium-sh/lazerbar) ⚠️ Archived** — `plutonyumm`\
...
<details>
<summary><strong>EndeavourOS</strong> (1)</summary>

* **[AdhikariKapil/dotfiles](https://github.com/AdhikariKapil/dotfiles) ⭐ 3 | 🐛 0 | 🌐 Lua | 📅 2026-07-18** — `Beyonder`\
  My very first rice. I combined bunch of config from bunch of people. Even tho I copied and tweaked different things it was very good first experience. It was first time in my life that i didn't sleep for 32 hrs. Enjoyed it alot. And gonna learn and make more because this is really fun.

</details>

<details>
<summary><strong>Fedora</strong> (1)</summary>

* **[ijadux2/Dotfiles](https://github.com/ijadux2/Dotfiles)** — `ijadux2`\
  Minimal setup
...
* **[michal-pielka/dotfiles](https://github.com/michal-pielka/dotfiles) ⭐ 3 | 🐛 2 | 🌐 Lua | 📅 2026-09-19** — `michalpielka`\
...
* **[Jotalea/i3-dots](https://github.com/Jotalea/i3-dots) ⭐ 3 | 🐛 0 | 🌐 Shell | 📅 2025-12-02** — `Jotalea`\
  this rice is inspired by the Geometry Dash level "Nullscapes", with the grayscale low-poly mountains background.
* **[sajidbytes/CLUNUX](https://github.com/sajidbytes/CLUNUX) ⭐ 2 | 🐛 0 | 🌐 Lua | 📅 2026-07-14** — `SajidBytes`\
...
* **[](https://catppuccin.com)** — `Jotalea`\
  I applied this theme to KDE Plasma, discord, kitty, and basically every program I use. even games like Minecraft.

dotfiles not available.
...
* **[melatonia/meloworld-dotfiles](https://github.com/melatonia/meloworld-dotfiles) ⭐ 124 | 🐛 0 | 🌐 QML | 📅 2026-08-16** — `melatonia`\
...
* **[cr1ogen/cr1odots](https://github.com/cr1ogen/cr1odots) ⭐ 7 | 🐛 0 | 🌐 Lua | 📅 2026-09-19** — `cr1ogen`\
...
* **[ORFLEM/just\_enough\_shell](https://github.com/ORFLEM/just_enough_shell/tree/main) ⭐ 32 | 🐛 0 | 🌐 QML | 📅 2026-09-11** — `_ORFLEM_`\
...
JES have a simple plugin system: just drop a folder with QML, import in shell.qml, and you're good. I've documented the process in the repo.
